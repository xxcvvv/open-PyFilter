'''
Autor: Mijie Pang
Date: 2024-02-29 21:22:56
LastEditTime: 2024-04-10 20:37:40
Description: 
'''
import os
import sys
...
def main(Config: dict, **kwargs):
    ...
    if assimilation_time == execute_time:
        ...
        time_set = [assimilation_time for i_time in range(len(time_set))]
    ...
    X_f_read = np.zeros([Ne, Nspec, Nlev, Nlat, Nlon])
    ...
    if Config['Assimilation']['post_process']['save_variables']:
        ...
        if Config['Assimilation']['post_process']['save_method'] == 'npy':
            ...
            var_output.save('prior_dust_all', X_f_read)
    ...
    X_f_extend = X_f_extend.reshape([Ne, Ns])
    ...
    if Config['Assimilation'][assimilation_scheme]['write_restart']:
        ...
        var_output.save('posterior_dust_all', X_a_3d)
